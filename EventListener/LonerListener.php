...
class LonerListener
{
    ...
    {
        // Get the loner key for this job: lonerKey
        // Check if it's queued: isLonerQueued
        //     If it's not, mark it as such: markLonerAsQueued
    }

    public function onAfterPerform($event)
    {
        // Done, mark it: markLonerAsUnqueued
    }

    public function onFailure($event)
    {
        // Also done, mark it: markLonerAsUnqueued
    }
